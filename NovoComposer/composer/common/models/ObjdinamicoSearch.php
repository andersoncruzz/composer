...
/**
 * ObjdinamicoSearch represents the model behind the search form about `common\models\ObjDinamico`.
 */
class ObjdinamicoSearch extends ObjDinamico
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['assunto', 'caminho', 'descricao', 'topicos', 'referencias', 'tipo', 'serie'], 'safe'],
        ];
    }
