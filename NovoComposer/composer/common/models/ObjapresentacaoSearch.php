...
/**
 * ObjapresentacaoSearch represents the model behind the search form about `common\models\ObjApresentacao`.
 */
class ObjapresentacaoSearch extends ObjApresentacao
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'qteSlides', 'exerciciosResolvidos', 'duracao', 'avaliacao'], 'integer'],
