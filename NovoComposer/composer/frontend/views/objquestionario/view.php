...
<div id="tudo">
    ...
    <script>
        ...
        function searchObejects(e){
            ...
            var ip = "<?= $aux ?>";
            console.log(ip);
            $.get("http://"+ip+"/NovoCompose/NovoComposer/composer/frontend/web/index.php?r=objquestionario/find&titulo="+e.value, function(data, status){
                /**
        ...
        function  addObject(e){
            ...
            var url = "http://"+window.location.hostname+"/NovoCompose/NovoComposer/composer/frontend/web/index.php?r=objquestionario/add&idCat="+category+"&idObj="+itens[indice].id+"&type="+itens[indice].tipo;
            console.log(url);
